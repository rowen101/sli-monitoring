            ...
            <div
                ...
                <div
                    ...
                    <div style="height:200px;width:100%;margin-top:60px;border-bottom:1px solid #c3cdc9">
                        ...
                        <h2 style="font-weight:500;color:#2d4f43">Job Order Request</h2>

                    </div>
                    <div style="padding:48px;margin:auto;text-align:left">

                        {{-- Show this if the status is 'A' (Approved) or 'C' (Rejected) --}}
                        <?php if ($jobRequest->status === 'A' || $jobRequest->status === 'C') : ?>
                        <p>
                            <strong>Hi {{ $jobRequest->created }}!</strong>
                        </p>
                        <?php endif; ?>

                        {{-- Show this if the status is 'P' (Pending) --}}
                        <?php if ($jobRequest->status === 'P') : ?>
                        <p>
                            <strong>Hi {{ $jobRequest->departmenthead }}!</strong>
                        </p>
                        <p>{{ $jobRequest->created }} has requested your approval for the following:</p>
                        <?php endif; ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="border-bottom:1px solid #c3cdc9;padding:10px">
                                        <div
                                            style="text-transform:uppercase;font-size:12px;color:#2d4f43;font-weight:bold">
                                            Job Order Number</div>
                                        <div>
                                            {{ $jobRequest->job_order_number }}
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="border-bottom:1px solid #c3cdc9;padding:10px">
                                        ...
                                        <div>
                                            {{ $jobRequest->problem_description }}
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="border-bottom:1px solid #c3cdc9;padding:10px">
                                        ...
                                        <div>
                                            ...
                                            if ($jobRequest->status === 'P') {
                                                $badgeClass = 'badge-warning';
                                                $statusText = 'Pending';
                                            } elseif ($jobRequest->status === 'A') {
                                                $badgeClass = 'badge-success';
                                                $statusText = 'Approved';
                                            } elseif ($jobRequest->status === 'C') {
